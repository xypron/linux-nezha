...
static void __init sun20i_d1_r_ccu_setup(struct device_node *node)
{
	void __iomem *reg;
	...
	sunxi_ccu_probe(node, reg, &sun20i_d1_r_ccu_desc);
}
CLK_OF_DECLARE(sun20i_d1_r_ccu, "allwinner,sun20i-d1-r-ccu",
	       sun20i_d1_r_ccu_setup);
